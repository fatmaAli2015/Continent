...
/**
 * Created by Fatma Ali on 25/09/2017.
 */

public class ChoiceQuestion_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            InputStream IS = getAssets().open("Qu_3.txt");
        ...
        try {
            InputStream IS = getAssets().open("An_3.txt");
            InputStreamReader ISR = new InputStreamReader(IS);
            BufferedReader BR = new BufferedReader(ISR);
            String line;
            while ((line = BR.readLine()) != null) {
